...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c*{4}{Y}}
        ...
        \midrule
        L0 & 51.40  & 160.03  & 431.84  & 419.04 \\
        L1 & 1.37   & 5.92    & 21.39   & 23.38  \\
        L2 & 1.10   & 4.26    & 16.99   & 18.04  \\
        L3 & 0.66   & 2.78    & 10.74   & 11.22  \\
        \bottomrule
    \end{tabularx}
...
\begin{itemize}
    ...
    \item \textbf{Janela $W = 4$}: $U = \frac{4 \times 0{,}2}{300{,}2} \approx 0{,}27\%$, 4x melhor, mas ainda muito baixo.
    \item \textbf{Janela $W = 16$}: $U = \frac{16 \times 0{,}2}{300{,}2} \approx 1{,}06\%$, 16x melhor que o SAW.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{c*{4}{Y}}
        ...
        \midrule
        P1 & 380    & 7.296   & 50    & 60    \\
        P2 & 1.572  & 17.180  & 291   & 260   \\
        P3 & 2.227  & 25.150  & 633   & 616   \\
        P4 & 4.652  & 36.048  & 2.291 & 2.271 \\
        \bottomrule
    \end{tabularx}
...
\begin{table}[H]
    \centering
    \caption{Custo de Retransmissões: GBN vs SR sob Reordenação}
    \begin{tabularx}{\textwidth}{c*{4}{Y}}
        \toprule
        \textbf{Cenário} & \textbf{Go-Back-N ($W=4$)} & \textbf{Go-Back-N ($W=16$)} & \textbf{Selective Repeat ($W=4$)} & \textbf{Selective Repeat ($W=16$)} \\
        \midrule
        R1 (10\%) & 1.760  & 25.962 & 2 & 1  \\
        R2 (25\%) & 3.758  & 36.561 & 1 & 17 \\
        \bottomrule
    \end{tabularx}
    \label{tab:comparativo_reordenacao}
\end{table}

\noindent Os dados confirmam o comportamento teórico: sob R2 com $W=16$, o GBN registrou \textbf{36.561 retransmissões} contra apenas \textbf{17 do SR}, uma diferença de mais de 2.000 vezes. No SR, pacotes fora de ordem são bufferizados e não geram retransmissões imediatas, enquanto no GBN cada reordenação dispara o reenvio de toda a janela.
